...
import java.io.*;
/**
 * Persona es la clase que se encarga de crear los atributos y metodos de una persona. 
 * 
 */
public class Persona implements Serializable{
	...
	*/
	 ...
	 * @return color se refiere al color de la persona
	*/
