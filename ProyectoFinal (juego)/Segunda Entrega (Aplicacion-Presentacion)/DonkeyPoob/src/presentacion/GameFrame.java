...
public class GameFrame extends JFrame { 
    ...
    public GameFrame(DonkeyPoob model, UnJugador panel, int width, int height) throws IOException //constructor
    {
    ...
    public GameFrame(DonkeyPoob model, UnJugador panel) throws IOException //constructor
    {
