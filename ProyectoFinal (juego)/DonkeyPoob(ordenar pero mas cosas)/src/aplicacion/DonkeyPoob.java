...
public final class DonkeyPoob extends Observable {
    ...
    public DonkeyPoob() //constructor, initialize game
    {
        initGame();	
    }
    ...
    public boolean startGame(DonkeyGUI frame) throws InterruptedException, IOException
    {
        while(epochs < 10000) //after epochs read 10000, the game will end
        {
            ...
            UnJugador tempPanel = frame.getGamePanel(); //get panel from the frame
