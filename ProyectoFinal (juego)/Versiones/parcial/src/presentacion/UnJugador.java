...
public class UnJugador extends JPanel implements Observer {
    ...
    Image magic= new ImageIcon(getClass().getResource("/resources/platformaMagic.png")).getImage();
	...
	public UnJugador() {
	     ...
	     //usando un diseno de bolsa de rejilla en el panel con restricciones
	...
	public UnJugador(DonkeyPoob model) 
    {
        setOpaque(true);
	...
	public void PlayGame() throws InterruptedException, IOException
    {
        ...
        frame = new PantallaJuego(model); //crear el frame del modo de juego
    ...
    public void paintComponent(Graphics g) 
    {
      ...
      //  g.drawImage(hammer, 60, 120, 100, 100, this);
        for (ObjetoEstatico object : model.getSOList()) //pintar cada objeto estatico, escaleras,plataformas y peach
        {
            if(object instanceof Plataforma)
            	if(object instanceof PlataformaMagica) {
            		g.drawImage(magic,(int)object.getXPos(), (int)object.getYPos(), (int)object.getWidth(), (int)object.getHeight(), null);	
            	}
            	else {
        ...
        {
            if(object instanceof Barril) {
            	if(object instanceof prueba) g.drawImage(ball,(int)object.getXPos(), (int)object.getYPos(), (int)object.getWidth(), (int)object.getHeight(), null);
            	else {
