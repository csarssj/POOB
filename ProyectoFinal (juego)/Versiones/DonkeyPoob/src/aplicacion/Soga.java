...
/**
 * Clase soga la cual mario sube para cambiar de plataforma (extiende objetoEstatico)
 * @author Cesar Gonzalez y Brayan Buitrago
 * @version 4/12/2019
*/

public class Soga extends ObjetoEstatico {
	/**
	 ...
	 */
    public Soga(int x, int y, int h, int w)
    {
        super(x, y, h, w); 
    }
