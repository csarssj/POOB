    ...
    public boolean checkSOCollisions(ArrayList<ObjetoEstatico> SOList) 
    {
        for(ObjetoEstatico SO : SOList)
        {
            ...
            if (SO instanceof Escalera) {
            	float l3 = SO.xPos, r3 = SO.xPos+SO.width, t3 = SO.yPos, b3 = SO.yPos+SO.height; // establecer las coordenadas del lado izquierdo, derecho, superior e inferior del otro objetot
