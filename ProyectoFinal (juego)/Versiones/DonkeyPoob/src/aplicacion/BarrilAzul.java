...
public class BarrilAzul extends Barril {
    ...
    public boolean checkSOCollisions(ArrayList<ObjetoEstatico> SOList) 
    {
        for(ObjetoEstatico SO : SOList)
        {
            ...
            float l2 = SO.xPos, r2 = SO.xPos+SO.width, t2 = SO.yPos-100, b2 = t2+SO.height; // establecer las coordenadas del lado izquierdo, derecho, superior e inferior del otro objetot
