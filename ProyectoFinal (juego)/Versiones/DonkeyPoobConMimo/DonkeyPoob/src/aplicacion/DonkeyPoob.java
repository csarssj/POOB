...
public final class DonkeyPoob extends Observable implements Serializable {
    ...
    private JugadorMimo luigi; //jugador 2 //DEBE SER CAMBIADO Luigi
    ...
    */
    ...
    {   
        ...
        if(model=="normal") {
        	System.out.println("AQUI ME LEE");
        	...
        	mario = new Mario(60,600,35,20, SOList);
        	luigi = new JugadorMimo(40,600,35,20, SOList);
        	jugadores.add(mario);
        	jugadores.add(luigi);
        	MOList.add(mario);
        	MOList.add(luigi);
        	...
        	System.out.println("AQUI SI QUE NO ME LEE");
        	mario = new Mario(60,600,35,20, SOList);
    ...
    {
    	System.out.println("Me genera los barriles");
        gravityTimes.add(0);
