...
public class Painter extends JPanel implements Observer {
	...
	public Painter(DonkeyPoob model) 
    {
        ...
        model = new DonkeyPoob("JugadorVsPc"); //crear nuevo modo de juego VS
        //model = new DonkeyPoob("normal"); //crear nuevo modo de juego
	...
	public Painter(String modo) {
	     try
         {
		     ...
		     if (modo.equals("JugadorVsJugador"))
	    	 	this.model = new DonkeyPoob("JugadorVsJugador"); //crear nuevo modo de juego
		     else if (modo.equals("JugadorVsPc"))
		     	this.model = new DonkeyPoob("JugadorVsPc");
                    ...
                    while (!endGame)
                    {
                    	...
                    	if (modoJuego.equals("normal")){
                            ...
                            else
                            {
                                ...
                                model = new DonkeyPoob("JugadorVsPc");
    ...
    public void paintComponent(Graphics g) 
    {
      ...
      //  g.drawImage(hammer, 60, 120, 100, 100, this);
        ...
        for (ObjetoMovimiento object : model.getMOList()) //pintar cada objeto en movimiento, barriles y mario
        {
            ...
            if(object instanceof JugadorMimo) g.drawImage(luigi, (int)object.getXPos(),(int)object.getYPos(),(int)object.getWidth(),(int)object.getHeight(), null);
