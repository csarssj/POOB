...
public class PantallaJuego extends JFrame{
    ...
    UnJugador menuPanel;
    Multiplayer gamePanel2; //panel que se usa en frame actual
    Multiplayer menuPanel2;//menu panel 
	...
	public PantallaJuego(DonkeyPoob model,UnJugador gameModel) //constructor
    {
		/*Prepare JFrame*/
	...
	public PantallaJuego(DonkeyPoob model,boolean cpu) throws IOException //constructor
    {
		//Prepare JFrame
		this.setTitle("Donkey Poob");
		this.setResizable(false);
		...
		addWindowListener(new FrameListener());
	    this.gameModel = model; //get model
	    gamePanel2 = new Multiplayer(model); //crear un panel de juego a partir de un modo de juego
	    this.add(gamePanel2); //agregar panel al frame
    }
    ...
    public Multiplayer getGamePanel2() 
    {
        return gamePanel2;
    }
