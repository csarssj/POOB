...
public class Canvas{
    ...
    public static Canvas getCanvas(int ancho, int largo){
        if(canvasSingleton == null) {
            canvasSingleton = new Canvas("BlueJ Shapes Demo", ancho, largo, 
                                         Color.white);
        }
        canvasSingleton.setVisible(true);
        return canvasSingleton;
    ...
    public void setForegroundColor(String colorString){
        Color goldrod  = new Color(218,165,32);
        Color firebrick  = new Color(139, 26, 26);
        Color darkGolden = new Color(139, 101, 8);
        Color chocolate = new Color(205, 102, 29);
        Color lightgreen  = new Color(144, 238, 144);
        Color grayneutro  = new Color(181, 181, 181);
        Color darkcyan  = new Color(0, 139, 139);
        Color yellowdark = new Color(139, 139, 0);
        Color peru  = new Color(205, 133, 63);
        Color darkpurple  = new Color(139, 101, 8);
